...
const koleksicekliskd = () => {
    ...
    for (o = 0; o < jsondatasiswa.length; o++) {
        ...
        for (b = 0; b < datamapel.length; b++) {
            ...
            if (kolomkds !== 0) {
                for (c = 0; c < kolomkds; c++) {
                    ...
                    let nilaisementara = fungsirerataKD("PH", `${jsondatasiswa[o].pd_nama}`, `${datamapel[b]}`, `${KD3[datamapel[b]][c]}`);
        ...
        for (f = 0; f < datamapel.length; f++) {
            ...
            if (kolomkds !== 0) {
                for (g = 0; g < kolomkds; g++) {
                    let nilaisementarapts = fungsirerataKD("PTS", `${jsondatasiswa[o].pd_nama}`, `${datamapel[f]}`, `${KD3[datamapel[f]][g]}`);
        ...
        for (m = 0; m < datamapel.length; m++) {
            ...
            if (kolomkds !== 0) {
                for (n = 0; n < kolomkds; n++) {
                    let nilaisementarapaspak = fungsirerataKD("PASPAK", `${jsondatasiswa[o].pd_nama}`, `${datamapel[m]}`, `${KD3[datamapel[m]][n]}`);
...
const fungsirerataKD = (t, namasiswa, mapel, kd) => {
    let doo = {};
    if (t == "PH") {
        doo = dataapiph.records.filter(k => k.namasiswa == namasiswa)[0];
    } else if (t == "PTS") {
        doo = dataapipts.records.filter(k => k.namasiswa == namasiswa)[0];

    } else if (t == "PASPAK") {
        doo = dataapipaspak.records.filter(k => k.namasiswa == namasiswa)[0];
...
const dataolahbeda = (arr) => {
    ...
    for (o = 0; o < jsondatasiswa.length; o++) {
        ...
        for (b = 0; b < datamapel.length; b++) {
            ...
            if (kolomkds !== 0) {
                for (c = 0; c < kolomkds.length; c++) {
                    ...
                    let nilaisementara = arr[o][kolomkds[c]];//kolomkds[c];//fungsirerataKD("PH", `${jsondatasiswa[o].pd_nama}`, `${datamapel[b]}`, `${KD3[datamapel[b]][c]}`);
                    // rekap += `<td  class="tt_rekapPH tt_KD3_${datamapel[b]}" style="visibility: visible;" contenteditable="true"> ${nilaisementara}</td>`;
                    rekap += `<td  class="tt_rekapPH tt_KD3_${datamapel[b]}"  contenteditable="true">${nilaisementara}</td>`;
                }
        ...
        for (f = 0; f < datamapel.length; f++) {
            ...
            if (kolomkds !== 0) {
                for (g = 0; g < kolomkds.length; g++) {
                    let nilaisementarapts = arr[o][kolomkds[g]];;//fungsirerataKD("PTS", `${jsondatasiswa[o].pd_nama}`, `${datamapel[f]}`, `${KD3[datamapel[f]][g]}`);
                    // rekap += `<td  class="tt_rekapPTS tt_KD3_${datamapel[f]}" style="visibility: hidden" contenteditable="true"></td>`;
                    rekap += `<td  class="tt_rekapPTS tt_KD3_${datamapel[f]}"  contenteditable="true">${nilaisementarapts}</td>`;
                }
        ...
        for (m = 0; m < datamapel.length; m++) {
            ...
            if (kolomkds !== 0) {
                for (n = 0; n < kolomkds.length; n++) {
                    let nilaisementarapaspak = arr[o][kolomkds[n]];;//fungsirerataKD("PASPAK", `${jsondatasiswa[o].pd_nama}`, `${datamapel[m]}`, `${KD3[datamapel[m]][n]}`);
                    //rekap += `<td  class="tt_rekapPAS  tt_KD3_${datamapel[m]}" style="visibility: hidden" contenteditable="true"></td>`;
                    rekap += `<td  class="tt_rekapPAS  tt_KD3_${datamapel[m]}" contenteditable="true">${nilaisementarapaspak}</td>`;
                }
    ...
    for (o = 0; o < jsondatasiswa.length; o++) {
        ...
        for (b = 0; b < datamapel.length; b++) {
            ...
            if (kolomkds !== 0) {
                for (c = 0; c < kolomkds; c++) {
                    //  console.log(KD3[datamapel[b]][c])
                    let nilaisementara = fungsirerataKDketerampilan("kpraktik", `${jsondatasiswa[o].pd_nama}`, `${datamapel[b]}`, `${KD4[datamapel[b]][c]}`);
                    // rekap += `<td  class="tt_rekapPH tt_KD3_${datamapel[b]}" style="visibility: visible;" contenteditable="true"> ${nilaisementara}</td>`;
        ...
        for (f = 0; f < datamapel.length; f++) {
            ...
            if (kolomkds !== 0) {
                for (g = 0; g < kolomkds; g++) {
                    let nilaisementarakproduk = fungsirerataKDketerampilan("kproduk", `${jsondatasiswa[o].pd_nama}`, `${datamapel[f]}`, `${KD4[datamapel[f]][g]}`);
                    // rekap += `<td  class="tt_rekapPTS tt_KD3_${datamapel[f]}" style="visibility: hidden" contenteditable="true"></td>`;
        ...
        for (m = 0; m < datamapel.length; m++) {
            ...
            if (kolomkds !== 0) {
                for (n = 0; n < kolomkds; n++) {
                    let nilaisementarakproyek = fungsirerataKDketerampilan("kproyek", `${jsondatasiswa[o].pd_nama}`, `${datamapel[m]}`, `${KD4[datamapel[m]][n]}`);
                    //rekap += `<td  class="tt_rekapPAS  tt_KD3_${datamapel[m]}" style="visibility: hidden" contenteditable="true"></td>`;
...
const fungsirerataKDketerampilan = (t, namasiswa, mapel, kd) => {
    let doo = {};
    if (t == "kpraktik") {
        doo = dataapikpraktik.records.filter(k => k.namasiswa == namasiswa)[0];
    } else if (t == "kproduk") {
        doo = dataapikproduk.records.filter(k => k.namasiswa == namasiswa)[0];

    } else if (t == "kproyek") {
        doo = dataapikproyek.records.filter(k => k.namasiswa == namasiswa)[0];
